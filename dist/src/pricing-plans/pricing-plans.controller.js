...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'order_by', required: false, enum: ['name', 'createdAt'], description: 'Sort by name or creation date' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Pricing plan not found', type: error_response_1.ErrorResponse }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request', type: error_response_1.ErrorResponse }),
