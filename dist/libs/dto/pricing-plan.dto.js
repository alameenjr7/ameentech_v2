...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Price of the plan', example: 10.00 }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], CreatePricingPlanDto.prototype, "price", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Features of the plan (JSON string)', example: '["Feature 1", "Feature 2"]' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
