import { IsNotEmpty, IsOptional, IsString, IsNumber, IsBoolean, IsDate, IsArray, ValidateNested } from 'class-validator';
import { PartialType, ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { Type } from 'class-transformer';

export class AboutDto {
  @ApiProperty({ description: 'Titre de la section à propos', example: 'À propos de nous' })
  @IsNotEmpty()
  @IsString()
  title: string;

  @ApiProperty({ description: 'Description principale', example: 'Nous sommes une équipe passionnée...' })
  @IsNotEmpty()
  @IsString()
  description: string;
  ...
  @ApiProperty({ description: 'Paragraphes (chaîne JSON)', example: '["Paragraphe 1", "Paragraphe 2"]' })
  @IsNotEmpty()
  @IsString()
  paragraphs: string;
