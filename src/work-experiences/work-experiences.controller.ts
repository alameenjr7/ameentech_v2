...
export class WorkExperiencesController {
  ...
  @ApiQuery({ name: 'order_by', required: false, enum: ['company', 'createdAt'], description: 'Sort by company or creation date' })
  ...
  @ApiResponse({ status: 404, description: 'Work experience not found', type: ErrorResponse })
  @ApiResponse({ status: 400, description: 'Bad request', type: ErrorResponse })
